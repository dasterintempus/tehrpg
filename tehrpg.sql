...
CREATE TABLE `Objects` (
	...
	FOREIGN KEY (`parent_id`) REFERENCES `Objects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
) ENGINE=InnoDB;
...
INSERT INTO `Objects` VALUES (NULL, NULL);
INSERT INTO `Tiles` VALUES (NULL, 0, 0, FALSE, "A divine void.", LAST_INSERT_ID());
INSERT INTO `Objects` VALUES (NULL, NULL);
INSERT INTO `Inventories` VALUES (NULL, NULL, DEFAULT, LAST_INSERT_ID());